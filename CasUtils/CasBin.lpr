...
{** Program : CasBin                                                    **}
{**                                                                     **}
{** Author : P.Harvey-Smith, 2011-08-01, 2021-11-16                     **}
{**                                                                     **}
{** Purpose : To create a binary tape file from an assembled or compiled**}
{**            binary file. Start and Exec address can be specified.    **}
{**                                                                     **}
{*************************************************************************}
